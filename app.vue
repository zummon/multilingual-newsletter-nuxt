...
watch(
	...
	(newLang) => {
		...
		// 	.setAttribute('href', translate.value.fontSrc);
	},
	{ immediate: true }
);
</script>
...
<template>
	<div class="max-w-3xl lg:max-w-4xl mx-auto">
		...
		<div class="p-7 md:p-12 flex flex-wrap-reverse gap-2 md:gap-4">
			...
			<div class="">
				<select class="border p-2" v-model="lang">
					<option
		...
		>
			...
			<div class="p-2 md:p-3 lg:p-4">
				<p
					class="
						first-letter:text-7xl first-letter:mr-2 first-letter:float-left
						text-justify
					"
				>
